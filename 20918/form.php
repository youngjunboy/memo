...
<body>
    <form name="member" action="insert.php" mehtod="post">
        <h2>회원 가입</h2>
        <ul class="join_form">
            <li>
                <span class="col1">아이디</span>
                <span class="col2"><input type="text" name="id"></span>
                <span class="col3"><button type="button" onclick="check_id()">
                        중복체크</button></span>
            </li>
            <li>
        ...
        <ul class="button">
            <li><button type="botton" onclick="check_input()">저장하기
        </button></li>
            <li><button type="botton" onclick="reset_form()">최소하기
        </button></li>
        </ul>
    </form>
</body>
